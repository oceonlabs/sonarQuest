...
import { isRedirect, isNotFound, defaultSerovalPlugins, makeSerovalPlugin, rootRouteId, createSerializationAdapter, joinPaths, trimPath, isResolvedRedirect, executeRewriteInput } from "@tanstack/router-core";
...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-C6E9N_B3.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-BHZN6cNY.js").then((n) => n.r);
    }
    if (startEntry === null) {
